...
## Inspiration
We first got the idea to create NFT Store by looking at the [$69 million Beeple's NFT](https://www.theverge.com/2021/3/11/22325054/beeple-christies-nft-sale-cost-everydays-69-million). The piece of art is made from 5,000 tiles merged together into a common canvas. Nowadays, as blockchain technologies are booming around us, NFT means Non-fungible token is emerging vigorously, one of those is NFT Games. The “play-to-earn” movement is a rising phenomenon in gaming, wherein players in NFT games collect rewards within the game that can later be converted to real cash. For that reason, our team is craving to join and apply this new technology so NFT Store is the name we chose. NFT Store offers the solution to create an NFT exchange between collectors. Besides NFT Store, in the near future, NFT Store will be the next product that aims to be a solution for NFT gaming liquidity.
## What it does
